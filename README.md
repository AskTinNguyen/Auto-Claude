...
![Auto CC Kanban Board](.github/assets/Auto-Claude-Kanban.png)
...
Auto CC uses a three-layer security model:
...
Auto CC is free to use. If you modify and distribute it, or run it as a service, your code must also be open source under AGPL-3.0.
