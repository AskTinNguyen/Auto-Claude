...
export type SidebarView = 'kanban' | 'terminals' | 'roadmap' | 'context' | 'ideation' | 'github-issues' | 'gitlab-issues' | 'github-prs' | 'gitlab-merge-requests' | 'changelog' | 'insights' | 'worktrees' | 'agent-tools' | 'scratchpad' | 'monitoring' | 'documentation';
...
const baseNavItems: NavItem[] = [
  ...
  { id: 'scratchpad', labelKey: 'navigation:items.scratchpad', icon: StickyNote, shortcut: 'S' },
  { id: 'documentation', labelKey: 'navigation:items.documentation', icon: FileEdit, shortcut: 'O' },
  { id: 'agent-tools', labelKey: 'navigation:items.agentTools', icon: Wrench, shortcut: 'M' },
  { id: 'monitoring', labelKey: 'navigation:items.monitoring', icon: BarChart3, shortcut: 'Y' },
    ...
    <TooltipProvider>
      <div className="flex h-full w-64 flex-col bg-sidebar border-r border-border">
        ...
        <div className="electron-drag flex h-14 items-center px-4 pt-6">
          <span className="electron-no-drag text-lg font-bold text-primary">Auto CC</span>
        </div>
